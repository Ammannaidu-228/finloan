    ...
    <div>
      ...
      <div className="w-200 m-auto">
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
          <div className="bg-gray-200 rounded-xl border-gray-400  w-90 p-5 m-auto">
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
              <h2 className="mt-10 text-xl tracking-tight text-gray-900">
                Join as a member
              </h2>
            </div>
      ...
      <div className="absolute lg:relative bottom-0 w-full">
        <Footer />
      </div>
    </div>
  );
